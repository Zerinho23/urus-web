...
const products = [
  // ──── FREE FIRE ────
  {
    ...
    plans: [
      ...
      { duration: "14 días", price: 12 },
      { duration: "30 días", price: 20 },
      { duration: "60 días", price: 30 },
      { duration: "90 días", price: 45 },
      { duration: "365 días", price: 90 },
    ] as Plan[],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    features: ["Aimbot external", "Menu chams pie 64", "Fake lag y teleport"],
    tagline: "Ideal para empezar",
    plans: [
      { duration: "3 días", price: 2 },
      { duration: "7 días", price: 5 },
      { duration: "14 días", price: 9 },
      { duration: "30 días", price: 10 },
      { duration: "60 días", price: 18 },
    ] as Plan[],
  },
  {
    id: 4,
    ...
    features: ["100% indetectable", "Compatible Windows 10/11", "Soporte 24/7"],
    tagline: "Sin rastros en Kellerss 2.0 y ProcessHacker",
    plans: [
      { duration: "1 mes", price: 50 },
      { duration: "2 meses", price: 70 },
    ] as Plan[],
  },
  {
    id: 5,
    ...
    features: ["Panel Chams & ESP", "Visión total del mapa", "Ajustes de color"],
    tagline: "Ve a todos los enemigos",
    plans: [
      { duration: "1 día", price: 2 },
      { duration: "3 días", price: 3 },
      { duration: "7 días", price: 6 },
      { duration: "15 días", price: 7 },
  ...
  },
  {
    ...
    plans: [
      { duration: "1 día", price: 4 },
      { duration: "7 días", price: 6 },
      { duration: "30 días", price: 10 },
      { duration: "90 días", price: 25 },
      { duration: "180 días", price: 45 },
      { duration: "360 días", price: 80 },
    ] as Plan[],
  },
  {
    id: 7,
    ...
    features: ["Bluestacks 5, MSI 5, MEMUPlay", "Anti-reporte", "FF Normal / FF Max"],
    tagline: "Tu cuenta protegida por UID",
    plans: [
      { duration: "7 días", price: 6 },
      { duration: "30 días", price: 10 },
      { duration: "90 días", price: 25 },
  ...
  },
  {
    ...
    badgeBg: "#fb923c",
    icon: <Shield className="h-9 w-9" />,
    features: ["Compatible Bluestacks", "FF Tela", "Actualizado"],
    tagline: "Bypass exclusivo para FF Tela",
    plans: [
      { duration: "7 días", price: 6 },
      { duration: "30 días", price: 10 },
    ] as Plan[],
  },
  {
    ...
    features: ["Combo Bypass + Panel", "Bluestacks 5 & MSI 5", "FF Normal & FF Tela"],
    tagline: "Combo completo: bypass y panel",
    plans: [
      { duration: "7 días", price: 13 },
      { duration: "30 días", price: 25 },
      { duration: "90 días", price: 50 },
      { duration: "180 días", price: 80 },
      { duration: "360 días", price: 100 },
    ] as Plan[],
  },
  {
    id: 10,
    ...
    plans: [
      { duration: "1 día", price: 5 },
      { duration: "7 días", price: 15 },
  ...
  // ──── BLOODSTRIKE ────
  {
    ...
    features: ["Aimbot para BloodStrike", "Wallhack ESP", "Funciones 100% seguras"],
    tagline: "Domina BloodStrike al máximo",
    plans: [
      { duration: "7 días", price: 8 },
      { duration: "15 días", price: 12 },
      { duration: "30 días", price: 18 },
    ] as Plan[],
  },
  {
    id: 12,
    ...
    icon: <Crown className="h-9 w-9" />,
    features: ["Acceso privado exclusivo", "Updates prioritarios", "Funciones 100% seguras"],
    tagline: "Nivel máximo de privacidad",
    plans: [
      { duration: "7 días", price: 10 },
      { duration: "14 días", price: 15 },
      { duration: "30 días", price: 20 },
    ] as Plan[],
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden" style={{ height: 160, background: `linear-gradient(160deg, ${product.gradientFrom} 0%, ${product.gradientTo} 100%)` }}>
        {hasImage ? (
          <>
            <img src={(product as typeof products[0] & { image: string }).image} alt={product.name}
          ...
          <>
            ...
            <div className="absolute rounded-full blur-3xl pointer-events-none"
              style={{ width: 180, height: 180, top: "50%", left: "50%", transform: "translate(-50%, -50%)", background: `radial-gradient(circle, ${hexToRgba(c, 0.28)} 0%, transparent 70%)`, opacity: hovered ? 1 : 0.6, transition: "opacity 0.3s" }} />
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="flex items-center justify-center rounded-2xl"
                style={{ width: 64, height: 64, background: hexToRgba(c, 0.1), border: `1.5px solid ${hexToRgba(c, 0.3)}`, color: c, transform: hovered ? "scale(1.12) rotate(5deg)" : "scale(1)", transition: "transform 0.3s ease", boxShadow: hovered ? `0 0 20px ${hexToRgba(c, 0.5)}` : "none" }}>
                {product.icon}
              </div>
            </div>
          </>
        ...
        <div className="absolute top-3 left-3 z-10">
          <span className="text-[9px] font-extrabold uppercase tracking-[0.18em] px-2 py-1 rounded-md"
        ...
        <div className="absolute top-3 right-3 z-10">
          <span className="text-[9px] font-extrabold tracking-widest px-2.5 py-1 rounded-md text-white"
      ...
      <div className="flex flex-col flex-1 p-4 gap-3">
        ...
        <div className="mt-auto pt-3" style={{ borderTop: `1px solid ${hexToRgba(c, 0.1)}` }}>
          ...
          <div className="flex items-center justify-between mb-2">
            <div>
              ...
              <div className="flex items-baseline gap-1">
                <p className="font-extrabold text-xl leading-none mt-0.5" style={{ color: hovered ? c : "white", transition: "color 0.2s" }}>
                  ${plan.price}
                </p>
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-3 py-1.5 rounded-lg mb-2 text-[11px] font-semibold transition-all"
            style={{
          ...
          {showPlans && (
            <div className="rounded-xl overflow-hidden mb-2" style={{ border: `1px solid ${hexToRgba(c, 0.2)}`, background: "rgba(0,0,0,0.5)" }}>
              {product.plans.map((p, i) => (
                <button
                  key={i}
                  onClick={() => { setSelectedPlan(i); setShowPlans(false); }}
                  className="w-full flex items-center justify-between px-3 py-2 text-[11px] transition-all"
                  style={{
                    background: selectedPlan === i ? hexToRgba(c, 0.15) : "transparent",
                    borderBottom: i < product.plans.length - 1 ? `1px solid ${hexToRgba(c, 0.1)}` : "none",
                    color: selectedPlan === i ? c : "rgba(255,255,255,0.5)",
                  }}
                >
          ...
          <button
            ...
            style={{
              ...
              boxShadow: added ? "0 0 14px rgba(34,197,94,0.4)" : `0 0 14px ${hexToRgba(c, 0.35)}`,
              color: "#000",
            }}
          >
