...
const products = [
  ...
  { id: 13, name: "Panel Undetected", game: "Free Fire", category: "freefire" as const, accentColor: "#06b6d4", gradientFrom: "#001a1f", gradientTo: "#0a0b0f", badge: "UNDETECTED", badgeBg: "linear-gradient(135deg,#06b6d4,#0e7490)", icon: <ShieldCheck className="h-9 w-9" />, features: ["100% indetectable", "Anti-ban activo", "Actualizaciones constantes"], tagline: "El panel que el anti-cheat no puede ver", plans: [{ duration: "7 días", price: 8 }, { duration: "30 días", price: 15 }] as Plan[] },
