    ...
    <div className="flex flex-col items-center gap-1.5">
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 20px rgba(251,191,36,0.1) inset, 0 4px 12px rgba(0,0,0,0.4)",
        }}
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 h-px" style={{ background: "rgba(251,191,36,0.1)" }} />
        <span
...
const freeProducts = [
  {
    ...
    features: ["Aimbots external", "Chams", "Fix Lag"],
    color: "#fbbf24",
  ...
  },
  {
    ...
    shortName: "BYPASS",
    game: "FREE FIRE",
    description: "Versión gratuita del bypass — 3 días de prueba. Contacta soporte en discord para recibir tu...",
    features: ["Indetectable", "Activacion Rapida", "Sin riesgo de black/ban"],
    color: "#fbbf24",
    glowColor: "rgba(251,191,36,0.25)",
    bgFrom: "rgba(251,191,36,0.12)",
  },
  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${hovered ? "rgba(251,191,36,0.7)" : "rgba(251,191,36,0.35)"}`,
        boxShadow: hovered
          ? "0 0 32px rgba(251,191,36,0.2), 0 8px 32px rgba(0,0,0,0.6)"
          : "0 0 10px rgba(251,191,36,0.06), 0 4px 16px rgba(0,0,0,0.4)",
    ...
    >
      ...
      >
        ...
        <div className="absolute top-3 right-3 z-10">
          <span className="px-2.5 py-1 rounded-full text-[11px] font-extrabold text-black"
