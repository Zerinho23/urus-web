...
const features = [
  {
    ...
    description: "Tecnología avanzada que garantiza invisibilidad total frente a todos los sistemas anti-cheat actuales.",
    color: "#22c55e",
    glow: "rgba(34,197,94,0.3)",
    bg: "rgba(34,197,94,0.08)",
    border: "rgba(34,197,94,0.25)",
    stat: "0 bans",
    statLabel: "reportados",
  },
  {
    icon: <Zap className="h-7 w-7" />,
    title: "Entrega Inmediata",
    description: "Acceso instantáneo a tus productos en segundos. Sin esperas, sin verificaciones manuales.",
    color: "#06b6d4",
  ...
  },
  {
    ...
    title: "Soporte 24/7",
    description: "Equipo disponible las 24 horas del día, los 7 días de la semana. Respondemos en minutos.",
    color: "#a855f7",
  ...
  },
  {
    ...
    description: "Todos los productos se actualizan frente a los últimos parches. Siempre en la última versión.",
    color: "#f97316",
    glow: "rgba(249,115,22,0.3)",
    bg: "rgba(249,115,22,0.08)",
    border: "rgba(249,115,22,0.25)",
    stat: "24h",
    statLabel: "tras cada parche",
  },
  {
    icon: <CreditCard className="h-7 w-7" />,
    title: "Pagos Seguros",
    description: "Múltiples métodos de pago con cifrado SSL. Transacciones 100% seguras y protegidas.",
    color: "#eab308",
  ...
  },
  {
    ...
    description: "Tu identidad y datos personales son completamente confidenciales. Nunca compartidos.",
    color: "#3b82f6",
    glow: "rgba(59,130,246,0.3)",
    bg: "rgba(59,130,246,0.08)",
    border: "rgba(59,130,246,0.25)",
    stat: "0 datos",
    statLabel: "compartidos",
  },
];
...
function FeatureCard({ f, index }: { f: typeof features[0]; index: number }) {
  ...
  return (
    <div
      ...
      style={{
        background: hovered
          ? `linear-gradient(135deg, ${f.bg} 0%, rgba(10,11,15,0.95) 100%)`
          : "linear-gradient(135deg, rgba(12,14,20,0.9) 0%, rgba(10,11,15,0.95) 100%)",
    ...
    >
      ...
      <div
        ...
        style={{ color: hovered ? f.color : "rgba(255,255,255,0.07)", transition: "color 0.3s" }}
      >
        0{index + 1}
      </div>
      ...
      <div
        ...
        style={{ borderTop: `1px solid ${hovered ? f.border : "rgba(255,255,255,0.05)"}`, transition: "border-color 0.3s" }}
      >
        <div>
        ...
        <div
          ...
          style={{
            background: hovered ? f.bg : "rgba(255,255,255,0.03)",
            border: `1px solid ${hovered ? f.border : "rgba(255,255,255,0.06)"}`,
            color: hovered ? f.color : "rgba(255,255,255,0.2)",
          }}
        >
